reports_list = [
  {
    ...
    user_id: 3,
    location_id: 7,
    state_waters: Location.find(7).state.name,
  ...
  },
  {
    ...
    user_id: 4,
    location_id: 4,
    state_waters: Location.find(4).state.name,
    date: rand(364).days.ago,
    catch_keepers: 12,
    catch_total: 15,
  ...
  },
  {
    ...
    user_id: 3,
    location_id: 3,
    state_waters: Location.find(3).state.name,
    date: rand(364).days.ago,
    catch_keepers: 1,
    catch_total: 1,
  ...
  },
  {
    ...
    user_id: 4,
    location_id: 12,
    state_waters: Location.find(12).state.name,
    date: rand(364).days.ago,
    catch_keepers: 8,
    catch_total: 20,
  ...
  },
  {
    ...
    user_id: 4,
    location_id: 5,
    state_waters: Location.find(5).state.name,
    date: rand(364).days.ago,
    catch_keepers: 3,
    catch_total: 3,
