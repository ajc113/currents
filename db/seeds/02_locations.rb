location_list = [
  ...
  },
  {
    ...
    long_name: "Coastal New Hampshire - Hampton Beach to Portsmouth including the Isle of Shoals",
    state_waters: "NH",
    demographic: "Inshore"      
  },
    {
    number: 1,
    short_name: "Southwest Maine",
    long_name: "South maine coast from Kittery north to Cape Elizabeth. Include York, Ogunquit, Wells, Saco.",
    state_waters: "ME",
    demographic: "Inshore"      
  },
      {
    number: 2,
    short_name: "Casco Bay",
    long_name: "All of Casco bay to Popham",
    state_waters: "ME",
    demographic: "Inshore"      
  },
  {
    number: 3,
    short_name: "Boothbay",
    long_name: "Popham to Bristol including Sheepscot River, Damariscotta River, Boothbay, and Bristol",
    state_waters: "ME",
    demographic: "Inshore"      
  },
  {
    number: 4,
    short_name: "St George",
    long_name: "Briston to Camden including Friendship, St George, Thomaston to Owl's Head",
    state_waters: "ME",
    demographic: "Inshore"      
  },
  {
    number: 5,
    short_name: "Penobscot Bay",
    long_name: "Penobscot Bay including Rockland, Camden, Penobscot River, Vinalhaven Island, to Isle Au Hout",
    state_waters: "ME",
    demographic: "Inshore"      
  },
    {
    number: 6,
    short_name: "Mt Desert Island",
    long_name: "Jericho Bay, Blue Hill Bay, Swan Island, Mt Desert Island, Frenchman Bay",
    state_waters: "ME",
    demographic: "Inshore"      
  },
    {
    number: 7,
    short_name: "Downeast Winter Harbor to Jonesport",
    long_name: "Downeast Maine - Schoodic Point, Great Island to Head Harbor Island",
    state_waters: "ME",
    demographic: "Inshore"      
  },
  {
